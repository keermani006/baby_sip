...
export function Modal({ open, onClose, title, children }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center">
      ...
      <div className="relative w-full sm:max-w-md bg-white/95 backdrop-blur-xl rounded-t-3xl sm:rounded-3xl shadow-glass-lg animate-slide-up max-h-[90vh] flex flex-col">
